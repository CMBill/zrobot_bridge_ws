...
public:
    ...
    {
        run_mode.index = index_list[0]; // 0x7005
        iq_ref.index = index_list[1]; // 0x7006
        spd_ref.index = index_list[2]; // 0x700A
        imit_torque.index = index_list[3]; // 0x700B
        cur_kp.index = index_list[4]; // 0x7010
        cur_ki.index = index_list[5]; // 0x7011
        cur_filt_gain.index = index_list[6]; // 0x7014
        loc_ref.index = index_list[7]; // 0x7016
        limit_spd.index = index_list[8]; // 0x7017
        limit_cur.index = index_list[9]; // 0x7018
        mechPos.index = index_list[10]; // 0x7019
        iqf.index = index_list[11]; // 0x701A
        mechVel.index = index_list[12]; // 0x701B
        VBUS.index = index_list[13];	// 0x701C
        rotation.index = index_list[14]; // 0x701D
    }
